export function currentScript(name: string): HTMLOrSVGScriptElement | null {
...
*/
export function replaceCSSVariables(variables: Record<string, string>) {
    const klaroStyleElements = document.querySelectorAll<HTMLStyleElement>('style[data-context=klaro-styles]');
